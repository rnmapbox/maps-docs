...
custom_props:
  example_rel_path: UserLocation/SetTintColor.js
custom_edit_url: https://github.com/rnmapbox/maps/tree/master/example/src/examples/UserLocation/SetTintColor.js
---
