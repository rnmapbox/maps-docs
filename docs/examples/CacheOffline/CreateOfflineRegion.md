...
custom_props:
  example_rel_path: CacheOffline/CreateOfflineRegion.js
custom_edit_url: https://github.com/rnmapbox/maps/tree/master/example/src/examples/CacheOffline/CreateOfflineRegion.js
---
