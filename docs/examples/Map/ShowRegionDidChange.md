...
tags: [MapView#onRegionWillChange, MapView#onRegionIsChanging, MapView#onRegionDidChange]
custom_props:
  example_rel_path: Map/ShowRegionDidChange.js
...
![ShowRegionDidChange.png](./ShowRegionDidChange.png)}
