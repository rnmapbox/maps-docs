...
tags: [MapView]
custom_props:
  example_rel_path: Map/TwoByTwo.js
custom_edit_url: https://github.com/rnmapbox/maps/tree/master/example/src/examples/Map/TwoByTwo.js
---
