...
custom_props:
  example_rel_path: FillRasterLayer/ImageOverlay.js
custom_edit_url: https://github.com/rnmapbox/maps/tree/master/example/src/examples/FillRasterLayer/ImageOverlay.js
---
