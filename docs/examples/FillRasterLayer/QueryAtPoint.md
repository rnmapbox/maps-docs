...
tags: []
custom_props:
  example_rel_path: FillRasterLayer/QueryAtPoint.js
custom_edit_url: https://github.com/rnmapbox/maps/tree/master/example/src/examples/FillRasterLayer/QueryAtPoint.js
---
...
![QueryAtPoint.png](./QueryAtPoint.png)}
